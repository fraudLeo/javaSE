...
import leo.algorithm.sort.Insertion;
import leo.algorithm.sort.Merge;
import leo.algorithm.sort.Shell;
...
public class SortCompare {
    public static void main(String[] args) throws Exception {
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(SortCompare.class.getClassLoader().getResourceAsStream("number.txt")));
        String line=null;
